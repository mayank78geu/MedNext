...
const DoctorDashboardLayout = () => {
  ...
  const navLinks = [
    { name: "Dashboard", path: "/doctor-dashboard", icon: LayoutDashboard, exact: true },
    { name: "Patient View", path: "/doctor-dashboard/patient-view", icon: Stethoscope },
    { name: "Schedule", path: "/doctor-dashboard/schedule", icon: CalendarDays },
    { name: "History", path: "/doctor-dashboard/history", icon: Clock },
    { name: "Profile", path: "/doctor-dashboard/profile", icon: User },
  ];
  ...
  return (
    <div className="flex h-screen bg-[#F4F7FB] font-sans overflow-hidden">
      ...
      {/* MAIN CONTENT AREA */}
      <main className="flex-1 overflow-y-auto mt-16 md:mt-0 relative text-[#0d1b2a]">
